...
<script src="http://manutd.ge/templates/redarmy-new/js/chart.js" type="text/javascript"></script>
    <!-- gauge.js -->
    ...
    <script src="{{asset('assets/admin')}}/vendors/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js" type="text/rocketscript"></script>
    ...
    <script src="{{asset('assets/admin')}}/vendors/jquery-confirm-master/js/jquery-confirm.js"></script>



    <script src="{{asset('assets/admin')}}/vendors/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
