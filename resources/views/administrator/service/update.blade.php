  ...
  <div class="x_content">
    ...
    <form method="POST" action="" data-parsley-validate class="form-horizontal"  enctype="multipart/form-data">
      ...
      <div class="tab-content" style="margin-top:20px;">
          ...
          @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
             @php $serviceDetails = $item->serviceDetail()->where('lang',$localeCode)->first(); @endphp
            ...
            <div class="tab-pane @if($localeCode == 'ge') active @endif" id="{{$localeCode}}">
               ...
               <div class="form-group">
                   ...
                   <div class="col-md-10 col-sm-10  col-xs-12">
                     <input type="text" name="title_{{$localeCode}}" class="form-control" id="title_{{$localeCode}}" required value="{{ $serviceDetails->title }}" >
                   </div>
               </div>
               ...
               <div class="form-group">
                   ...
                   <div class="col-md-10 col-sm-10  col-xs-12">
                      <textarea name="description_{{$localeCode}}" class="textarea" id="description_{{$localeCode}}" required>{{ $serviceDetails->description }}</textarea>
                   </div>
               </div>
          ...
          <div class="form-group" id="imgWrap">
             <div class="col-md-10 col-md-offset-2">
                <div class="panel panel-default" style="border-radius:0">
                   ...
                   <div class="panel-body">
                      <div class="row">
                         @foreach ($item->serviceImage as $key => $value)
              ...
              confirm: {
                   ...
                   action: function () {
                       $.ajax({
                           ...
                           url: '{{url("admin/service/deleteimg/")}}',
                           type: "post",
