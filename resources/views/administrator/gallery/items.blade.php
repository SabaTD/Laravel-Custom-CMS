...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_title">
				<h2>ალბომები</h2>
				<a href="{{url('admin/gallery/create')}}" class="btn btn-sm btn-success pull-right">
						...
						<tbody>
							@foreach($gallerys as $gallery)
								<tr>
									...
									<td class="text-center">
										<input type="checkbox" value="publish" id="{{$gallery->id}}" class="js-switch publish" @if($gallery->publish) checked  @endif />
									</td>


									<td class="text-left">
										<a href="{{url('admin/gallery/edit/'.$gallery->id)}}" title="რედაქტირება">
											@php
												$names = $gallery->galleryDetail()->where('lang', 'ge')->first();
												echo $names->title;
											@endphp
										</a>
									</td>
									...
									<td align="right">
										<a href="{{url('admin/gallery/edit/'.$gallery->id)}}" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i> </a>
										<a href="{{url('admin/gallery/delete/'.$gallery->id)}}" class="delete btn btn-danger btn-sm"><i class="fa fa-trash-o"></i>  </a>
									</td>
            ...
            $('.publish').change(function(event) {
				...
				$('.featured').change(function(event) {
					 ...
					 $.ajax({
						  ...
						  url: '{{url("admin/gallery/featured")}}',
