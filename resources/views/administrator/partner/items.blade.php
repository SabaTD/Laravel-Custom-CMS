...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_title">
				<h2>პარტნიორები</h2>
				<a href="{{url('admin/partner/create?model=Partner')}}" class="btn btn-sm btn-success pull-right">
						...
						<tbody>
							@foreach($items as $item)
								<tr>
									...
									<td class="text-left">
										<a href="{{url('admin/partner/edit/'.$item->id.'?model=Partner')}}" title="რედაქტირება">
											@php
												$names = $item->partnerDetail()->where('lang', 'ge')->first();
												echo $names->title;
											@endphp
										</a>
									</td>
									...
									<td align="right">
										<a href="{{url('admin/partner/edit/'.$item->id.'?model=Partner')}}" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i> </a>
										<a href="{{url('admin/partner/delete/'.$item->id.'?model=Partner')}}" class="delete btn btn-danger btn-sm"><i class="fa fa-trash-o"></i>  </a>
									</td>
        ...
        $(document).ready(function() {
            ...
            $('.publish').change(function(event) {
                ...
                $.ajax({
                    ...
                    url: '{{url("admin/partner/publish?model=Partner")}}',
